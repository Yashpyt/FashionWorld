...
from fashionworld.settings import RAZORPAY_API_KEY,RAZORPAY_API_SECRET_KEY
import razorpay
...
def forgetPassword1Page(Request):
    if(Request.method=="POST"):
        ...
        try:
            ...
            subject = 'OTP for Password Reset!!! team-: FashionWorld'
            message = """
                    Hello """+buyer.name+"""
            ...
            error(Request,"User Name Not Found in Our Record!!!")
